...
See [rendering of this file here](https://github.com/gh-metrics/metrics/blob/examples/metrics.markdown.full.md) and [original template source here](https://github.com/gh-metrics/metrics/blob/master/source/templates/markdown/example.md).
